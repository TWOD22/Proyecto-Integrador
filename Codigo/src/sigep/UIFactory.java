...
public final class UIFactory {
    ...
    public static JLabel badge(String text, Color bg, Color fg, Color border){
        JLabel l=new JLabel(text){
            @Override protected void paintComponent(Graphics g){
                Graphics2D g2=(Graphics2D)g.create();
                g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);
                g2.setColor(bg); g2.fillRoundRect(0,0,getWidth()-1,getHeight()-1,10,10);
                g2.setColor(border); g2.drawRoundRect(0,0,getWidth()-2,getHeight()-2,10,10);
                g2.dispose();
                super.paintComponent(g);
            }
        };
        l.setFont(Theme.FONT_BADGE); l.setForeground(fg); l.setOpaque(false);
    ...
    public static JLabel badgeEnCurso()   { return badge("En Curso",     Theme.BLUE_BG,   Theme.BLUE_TEXT,   Theme.BLUE_BORDER); }
